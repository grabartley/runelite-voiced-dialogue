...
/**
 * The two-tier synthesis cache behind {@link DialogueAudioService}: an in-memory {@link LruCache}
 ...
 */
@Slf4j
final class TieredSynthesisCache {
   ...
   */
  Pcm withInFlight(CacheKey key, Supplier<Pcm> synth, Runnable onDeduped) {
