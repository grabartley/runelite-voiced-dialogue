...
public class OpenRouterTtsBackendTest {
  ...
  private String inputForEmotion(Emotion emotion) throws Exception {
    ...
    return TestFixtures.spokenTranscript(sentBody().get("input").getAsString());
  }
  ...
  public void sendsBearerAuthAndJsonBody() throws Exception {
    ...
    assertEquals("Hello & welcome", TestFixtures.spokenTranscript(body.get("input").getAsString()));
  ...
  public void aLongLineIsSentWholeAndKeyedTheSameAsAShortOne() throws Exception {
    ...
    assertEquals(
        ...
        longLine,
        TestFixtures.spokenTranscript(sentBody().get("input").getAsString()));
  ...
  public void globalQuirkRoutesEnglishThroughTranslationAndKeepsTheBaseLanguageCode()
    ...
    assertEquals(
        ...
        "no cap, well met",
        TestFixtures.spokenTranscript(speech.get("input").getAsString()));
    assertEquals(
  ...
  public void nonEnglishTargetTranslatesBeforeVoicingAndSetsLanguageCode() throws Exception {
    ...
    assertEquals(
        ...
        "Bonjour",
        TestFixtures.spokenTranscript(body.get("input").getAsString()));
    assertEquals(
