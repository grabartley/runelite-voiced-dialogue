...
| **Auto-learn New NPCs** | `Off` | Looks an unrecognised NPC's race, gender, and origin up on the OSRS Wiki once and remembers it. Clicking **Talk-to** starts the lookup, so their first line usually lands in the right voice. |
