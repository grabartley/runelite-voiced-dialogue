...
- **A narrator for the story.** The message and item boxes quests lean on ("You find a key.", the cutscene beats between conversations) are read aloud by a dedicated narrator voice, so a quest keeps its voice at the moments it is actually about.
